                ...
                .addSubcommands(
                    SubcommandData("등록", "과제 등록")
                        .addOptions(
                            ...
                            OptionData(OptionType.STRING, "알림시각", "예: 2026-03-01 21:30 (KST)", true),
                            OptionData(OptionType.STRING, "마감시각", "예: 2026-03-02 23:59 (KST)", true),
                            OptionData(OptionType.CHANNEL, "채널", "알림 전송 채널(기본: 현재 채널)", false)
                                .setChannelTypes(ChannelType.TEXT),
                            OptionData(OptionType.ROLE, "알림역할", "지정 시 해당 역할만 멘션", false),
                            OptionData(OptionType.STRING, "임박알림", "예: 24,3,1 (기본값 동일)", false),
                            OptionData(OptionType.STRING, "종료메시지", "마감 후 전송할 메시지(선택)", false),
                        ),
